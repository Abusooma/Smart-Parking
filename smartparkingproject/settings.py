"""
Django settings for smartparkingproject project.
...
ROOT_URLCONF = 'smartparkingproject.urls'
...
# Ajoutez ceci si vous avez des dossiers statiques supplémentaires
STATICFILES_DIRS = [
...
AUTH_USER_MODEL = 'smartparking.CustomUser'
